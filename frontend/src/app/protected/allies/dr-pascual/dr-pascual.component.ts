...
@Component({
  selector: 'app-dr-pascual',
  templateUrl: './dr-pascual.component.html',
  styleUrls: ['./dr-pascual.component.css']
})
export class DrPascualComponent implements OnInit {
  public database: any = {}
  ...
  getDatabase(){
    this.petService.getDatabase()
      .subscribe(res => {
        this.database = res
        this.database = this.database.vets['dr-pascual-pet'].info
